...
Public Class CrystalReportEmployee
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TimeClock_Project.CrystalReportEmployee.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportEmployee
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportEmployee = New CrystalReportEmployee()
        rpt.Site = Me.Site
        Return rpt
    End Function
